...
class CDOShortcodes {
	...
	function init()
	{
		if( !is_admin() )
		{
			...
			wp_register_script( 'cdo-imagesloaded', CDO_PLUGIN_DIR_URL . 'js/imagesloaded.pkgd.min.js', array('jquery'), '', true);
			...
			wp_register_script( 'cdo-product-slider-slick', CDO_PLUGIN_DIR_URL . 'js/product.slider.slick.js', array('jquery'), '', true);
	...
	function admin_init()
	{
		...
		//register button to tinymce editor
