		...
		init: function ( editor, url )
		{
			...
			editor.addButton('cdo_button', {
				...
				text : 'Content',
					...
					{text: 'Pricing Tables', classes:'cdoCakePricingTables', onclick:function(){
